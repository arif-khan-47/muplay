...
function LandscapeCard({ name, thumbnail, duration, genres }: any) {
    return (
        <>
            <div className="bg-cover bg-center h-[211px] w-full rounded-xl" style={{ backgroundImage: `url(${thumbnail})` }}>
